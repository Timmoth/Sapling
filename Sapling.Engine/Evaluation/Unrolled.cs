...
public static unsafe partial class NnueEvaluator
{
    ...
    public static void SimdCopy256(VectorShort* destination, VectorShort* source)
    {
        ...
        destination[17] = source[17];
        destination[18] = source[18];
        destination[19] = source[19];
        destination[20] = source[20];
        destination[21] = source[21];
        destination[22] = source[22];
        destination[23] = source[23];
        destination[24] = source[24];
        destination[25] = source[25];
        destination[26] = source[26];
        destination[27] = source[27];
        destination[28] = source[28];
        destination[29] = source[29];
        destination[30] = source[30];
        destination[31] = source[31];
        destination[32] = source[32];
        destination[33] = source[33];
        destination[34] = source[34];
        ...
        destination[51] = source[51];
        destination[52] = source[52];
        destination[53] = source[53];
        destination[54] = source[54];
        destination[55] = source[55];
        destination[56] = source[56];
        destination[57] = source[57];
        destination[58] = source[58];
        destination[59] = source[59];
        destination[60] = source[60];
        destination[61] = source[61];
        destination[62] = source[62];
        destination[63] = source[63];
