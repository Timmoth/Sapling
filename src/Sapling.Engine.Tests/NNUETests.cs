...
//    public unsafe void Apply(ref BoardStateData board, string[] moves, int moveIndex)
//    {
...
//        board.FinishApply(board.WhiteAccumulator, board.BlackAccumulator, hashHistory, move, oldEnpassant, prevCastleRights);
